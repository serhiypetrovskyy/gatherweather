...
from subscription.utils import get_geo_coordinates, get_current_weather
...
class CurrentWeatherTestCase(TestCase):
    ...
    def test_get_current_weather(self):
        report = get_current_weather(self.lat, self.lon, self.api_key, self.weather_data_url, self.units, self.exclude)
